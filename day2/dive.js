...
console.log(divePosition(commandArr));

// second puzzle
function aimPosition(commands) {
    var horizontal = 0;
    var aim = 0; 
    var depth = 0; 
    for (var i = 0; i < commands.length; i++) {
...
console.log(aimPosition(commandArr)); 
